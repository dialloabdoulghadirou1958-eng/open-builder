...
export const en: typeof zh = {
  ...
  settings: {
    ...
    model: {
      label: "Model Name",
      hint: "AI model name, e.g. gpt-5.6-sol, deepseek-chat",
  ...
  chat: {
    ...
    projectImport: {
      ...
      description:
        "Read a local project folder or ZIP, apply safety filters, and replace the project workspace on the right.",
      pickFolder: "Choose project folder",
      folderHint: "Uses the File System Access API when available",
      pickZip: "Choose ZIP archive",
      zipHint: "Supports common project archives",
      stopFirst:
        "Stop the active generation before replacing the project workspace.",
      reading: "Reading and checking the project...",
      failed: "Project import failed: {message}",
      ...
      codeOnly:
        "No supported preview framework was detected. The workspace will open in code-only mode.",
      replaceWarning:
        "This workspace already has files. Continuing keeps the chat, replaces the files, and clears old snapshots and resumable local-agent sessions.",
      cancel: "Cancel",
      import: "Import project",
      replace: "Replace and import",
      success: "Imported {count} project files.",
    },
    skills: "Skills",
    stopGeneration: "Stop",
    send: "Send",
  ...
  tool: {
    ...
    mcpToolPending: "MCP Tool",
    unknownTool: "Unknown Tool",
    truncatedInUi: "Truncated in the UI after {count} characters",
    structuredContent: "Structured content",
    structuredContentUnavailable: "Structured content could not be displayed",
    mcpResultAlt: "MCP tool result",
    embeddedResource: "Embedded {type} resource",
    emptyEmbeddedResource: "Empty embedded resource",
    binary: "binary",
    emptyFileTree: "(empty)",
    morePathsOmitted: "{count} more paths omitted",
    status: {
      running: "Running",
      completed: "Completed",
      failed: "Failed",
    ...
    names: {
      ...
      project_health_check: "Check Project Health",
    },
  },
  subagent: {
    running: "Running",
